...
Hierarchical Correlation Reconstruction (HCR). In \cref{fig:architecture} there is presented high-level approach to construct GNN with HCR. While the two tasks share this common foundation, their implementation details differ in several respects; 
