...
%refreshed results with 8 endpoints evaluated
    ...
    Since the architectures achieve comparable performance, the choice for 
...
Taken together, the gate matrix indicates that the evidence branch is used
...
Taken together, it is worth to emphasize that all of models with HCR reached a satisfactory results 
