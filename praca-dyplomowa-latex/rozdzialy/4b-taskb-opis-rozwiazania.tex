...
Training iterates over patient graphs batched via PyTorch Geometric's DataLoader. The experiments were run with
...
Due to rare events the main metric for model choice was AUPRC. 