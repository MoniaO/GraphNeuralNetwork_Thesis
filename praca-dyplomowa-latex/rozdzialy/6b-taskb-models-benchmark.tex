...
Task~B is evaluated on a second benchmark dataset derived from Hetionet
(\cref{subsec:hetionet}). The
benchmark is a \textbf{structural proxy}---the
pipeline, layer slots, and HCR branch are reused, but the graph is
...
task. Adapting it nevertheless required a couple of reconstructions
listed below.
