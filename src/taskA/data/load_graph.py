...
from taskA.data.feature_ablation import (
    apply_feature_ablation,
    feature_fingerprint,
    print_feature_summary,
)
from taskA.data.interventions import (
    graph_fingerprint,
    remove_relation_types,
)
from taskA.data.hetero_graph import (
    load_native_heterodata,
)
from taskA.data.layout import (
...
def load_recon_heterodata(cfg: Any):
    ...
    if motif_completion_enabled(cfg):
        ...
        from taskA.data.motif_completion import hide_tasks
