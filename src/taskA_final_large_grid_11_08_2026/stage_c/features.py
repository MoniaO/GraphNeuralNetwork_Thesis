"""Train-only statistical pair features for Stage C S0–S10 (11.08.2026).

Hard rules:
- fit on train patients only (no val/test)
- never use G_true / edge labels
- no silent binarize for HCR_BINARY_ONLY
- reuse Panel B pack_pair_vector_40 / robust-z from summaries
"""
...
from hcr.wave7.panel_b.summaries import active_mask, continuous_marginal
...
def fit_stage_c_features(
    ...
    *,
    ...
    from hcr.wave7.encoder import patient_train_fingerprint
