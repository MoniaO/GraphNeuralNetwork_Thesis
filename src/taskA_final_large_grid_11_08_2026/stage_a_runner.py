...
from taskA_final_large_grid_11_08_2026.stage_a_grid import (
    CANDIDATE_SEED,
    FIXED,
    SCENARIOS,
    SCREENING_SEEDS,
...
def build_overrides(
    ...
    *,
    ...
    # hcr=none is mandatory for Stage A: final_ghcr would trigger wave7c attach
    # via hcr.encoder == wave7c_b2_audit even with enabled=false paths.
    ov = [
        "model=TaskA_hgt_final",  # base group; architecture fields overridden below
        "hcr=none",
        "data=dataset_v3",
        ...
        # Neutralize nested model.hgt.* from TaskA_hgt_final so it cannot
