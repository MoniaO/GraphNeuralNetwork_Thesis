...
#     "generation_seed", "paired_patient_key", "hospital_contact", "fall_reported", "adr_reported", "mood_screening_done"
# ]
...
#     # --- (D) numeryczna warstwa topologiczna, dolaczana do cech statycznych ---
#     nodes = nodes.copy()
#     nodes["layer_numeric"] = nodes["layer"].map(_layer_to_numeric)
#     static_cols = STATIC_FEATURE_COLS + ["layer_numeric"]
...
#     # odwrotne do intencji przy skali 1-10.
...
#     print(f"Scenario: {scenario}  |  observability_regime: {observability_regime}")
