...
TOTAL = 33
POLL = 120
PATTERN = "run_taskA_stage_c_stats_11.08.2026.py"
...
def start():
    ...
    p=subprocess.Popen([str(REPO/".venv/bin/python"),"-u",str(REPO/"scripts/run_taskA_stage_c_stats_11.08.2026.py"),"--mode","screen","--scenario","clean","--heads","4"], cwd=str(REPO), env=env, stdout=logf, stderr=subprocess.STDOUT, start_new_session=True)
