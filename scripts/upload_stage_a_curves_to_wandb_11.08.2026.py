#!/usr/bin/env python3
"""Backfill Stage A runs to W&B: epoch loss (optim) + AUPRC/AUC curves.

Parses train_11.08.2026.log under the dated Stage A block and logs history.
Does not retrain. Safe to re-run (creates new runs with suffix _backfill).
"""
