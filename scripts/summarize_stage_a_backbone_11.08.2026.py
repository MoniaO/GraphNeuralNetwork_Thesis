#!/usr/bin/env python3
"""Aggregate Stage A shared-screen results → decision tables (valid AUPRC only).

Selection rule (protocol): mean valid AUPRC over screening seeds; test is sealed.
Writes CSV + Markdown under outputs/taskA_final_large_grid_11.08.2026/stage_a/.
"""
