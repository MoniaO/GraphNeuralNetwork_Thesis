...
Modern pharmacotherapy involves complex interactions between drugs, patient characteristics,
biological mechanisms, intermediate physiological states, and clinical outcomes.
Representing such knowledge using knowledge graphs provides a natural way to organize
clinically relevant entities and their relationships into an explicit relational structure.

The topology of a knowledge graph describes which relationships are considered plausible or
...
On the other hand, patient-level data contain empirical information about drug exposure,
patient context, intermediate states, and clinical outcomes,
but these observations do not directly provide the mechanistic structure connecting them.
...
\paragraph{Thesis 1.}
Empirical patient-level data can improve the prediction of missing directed links in a knowledge graph.
...
\paragraph{Thesis 3.}
Explicit empirical associations can provide additional signal to GNNs and improve prediction performance.
...
Based on that and taking into consideration formulated thesis,
